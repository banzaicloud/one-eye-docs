...
1. Import the YAML configuration of the resource, or create a new one in the browser.
    ...
    - For details on the possible configuration values, see [Logging flows]({{< relref "/docs/one-eye/logging-operator/configuration/crds/_index.md" >}}) and [Logging outputs]({{< relref "/docs/one-eye/logging-operator/configuration/crds/_index.md" >}}).
